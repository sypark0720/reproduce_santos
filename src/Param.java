public class Param {
    ...
    public static final int periods = 3; //paper: 100000 -generations to be in equalibrium //3000정도면 0.01 이하됨
    public static final int periodsAvged = 15; //paper: 2000 -위의 periods가 지난 다음 얼마만큼의 generation을 평균낼 것인지


    //in one graph, total rounds
    public static final int runsPerGraph = 5; //paper: 100 -한 그래프당 몇 번 돌릴 건지

    //in whole process
    public static final int realization = 1; //paper: 10 -몇 개의 그래프를 돌릴 껀지


    public static final int nNodes = 50; //total number of nodes
