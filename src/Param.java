public class Param {
    ...
    //Parameters
    public static final int nSample = 19; //paper: 20 - the number of measured r
    ...
    public static final int periods = 1000; //paper: 100000 -generations to be in equalibrium
    public static final int REALIZATION = 1;
    public static final int RUNFORREALIZATION = 5;
